...
async function checkout() {
    ...
    // Ví dụ đơn giản: chỉ gửi danh sách item
    const orderRequest = {
        items: cart,       // [{id, name, price, qty, imageUrl}, ...]
        note: "Đơn tạo từ website user"
        // sau này bạn có thể thêm thông tin khách hàng: tên, sđt, địa chỉ...
    };
    ...
    try {
        ...
        if (!res.ok) {
            throw new Error("Lỗi tạo đơn hàng: " + res.status);
        }
...
// gắn event cho nút "Đặt hàng"
window.addEventListener("load", () => {
    loadCart(); // cái cũ bạn đã có
